...
$seo_data = [
    ...
    'toyota' => [
        ...
        'models' => [
            ...
            'urban cruiser' => [
                'title' => 'Toyota Hyryder PDI Checklist | Hybrid SUV Inspection',
                'description' => 'Verify your Hyryder. Strong hybrid switching, EV mode, and AWD system checks.',
                'keywords' => 'Hyryder PDI, Urban Cruiser inspection, Hybrid SUV check'
            ],
            'hilux' => [
...
if ($brand_param) {
    ...
    if (isset($seo_data[$brand_key])) {
        ...
        if ($model_param) {
            ...
            if (isset($seo_data[$brand_key]['models'])) {
                ...
                foreach ($seo_data[$brand_key]['models'] as $mKey => $mData) {
                    // Simple loose check: if param contains key or key equals param
                    if ($mKey == $model_key || strpos($model_key, $mKey) !== false) {
        ...
        if (!$found_override && !$model_param) {
            $found_override = $seo_data[$brand_key];
